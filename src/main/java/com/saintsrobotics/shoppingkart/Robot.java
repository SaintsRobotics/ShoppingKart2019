...
import com.saintsrobotics.shoppingkart.config.CuriositreeMotors;
import com.saintsrobotics.shoppingkart.config.CuriositreeSensors;
...
public class Robot extends TaskRobot {
	...
	public void robotInit() {
		Robot.instance = this;
		this.oi = new OI();
		this.motors = new CuriositreeMotors();
		this.motors.init();
		this.sensors = new CuriositreeSensors();
		this.sensors.init();
	...
	public void teleopInit() {
		...
		this.teleopTasks = new Task[] { new ResetGyro(() -> this.oi.xboxInput.START()), swerveInput, swerveControl,
				...
				new ToHeight(() -> this.oi.oppInput.DPAD_DOWN(), this.liftControl, 35),
